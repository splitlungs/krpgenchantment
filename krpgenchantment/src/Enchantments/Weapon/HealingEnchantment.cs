...
namespace KRPGLib.Enchantment
{
    public class HealingEnchantment : Enchantment
    {
        ...
        // string DamageResist { get { return Attributes.GetString("DamageResist", "resistheal"); } }
        ...
        public override void OnAttack(EnchantmentSource enchant, ref Dictionary<string, object> parameters)
        {
            ...
            // Convert default damage
            if (parameters?.ContainsKey("damage") == true)
                parameters["damage"] = 0;
